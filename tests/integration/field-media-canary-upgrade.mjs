...
values (
  ...
  '${COMPANY_ID}',
  '96400000-0000-4000-8000-000000000201',
  'StoryOps controlled rehearsal property',
  'other',
...
values
  (
    '${CONSUMED_CREW_ID}',
    '${COMPANY_ID}',
    'StoryOps controlled rehearsal 96410000',
    false,
  ...
  (
    '${VERIFIED_CREW_ID}',
    '${COMPANY_ID}',
    'StoryOps controlled rehearsal 96420000',
    true,
    '10000000-0000-4000-8000-000000000103',
    '{}',
    '00000'
  ...
  (
    ...
    '${COMPANY_ID}',
    'StoryOps controlled rehearsal 96440000',
    false,
    '10000000-0000-4000-8000-000000000103',
    '{}',
    '00000'
